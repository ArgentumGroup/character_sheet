...
spells = Spell.create! ([
  ...
  # {name: "", cleric: true, wizard: false, level:, casting_time: "", range: "", verbal: , somatic: , material: , components: "", duration: "", description: "You touch one object that is no larger than 10 feet in any dimension. Until the spell ends, the object sheds bright light in a 20-foot radius and dim light for an additional 20 feet. The light can be colored as you like. Completely covering the object with something opaque blocks the light. The spell ends if you cast it again or dismiss it as an action."},
  # {name: "", cleric: true, wizard: false, level:, casting_time: "", range: "", verbal: , somatic: , material: , components: "", duration: "", description: "You touch one willing creature. Once before the spell ends, the target can roll a d4 and add the number rolled to one saving throw of its choice. It can roll the die before or after making the saving throw. The spell then ends."},
  # {name: "", cleric: true, wizard: false, level:, casting_time: "", range: "", verbal: , somatic: , material: , components: "", duration: "", description: "Flame-like radiance descends on a creature that you can see within range. The target must succeed on a Dexterity saving throw or take 1d8 radiant damage. The target gains no benefit from cover for this saving throw."},
  # {name: "", cleric: true, wizard: false, level:, casting_time: "", range: "", verbal: , somatic: , material: , components: "", duration: "", description: "You ward a creature within range against attack. Until the spell ends, any creature who targets the warded creature with an attack or a harmful spell must first make a Wisdom saving throw. On a failed save, the creature must choose a new target or lose the attack or spell. This spell doesn’t protect the warded creature from area effects, such as the explosion of a fireball. If the warded creature makes an attack or casts a spell that affects an enemy creature, this spell ends."},
  # {name: "", cleric: true, wizard: false, level:, casting_time: "", range: "", verbal: , somatic: , material: , components: "", duration: "", description: "A shimmering  eld appears and surrounds a creature of your choice within range, granting it a +2 bonus to AC for the duration."},
  # {name: "", cleric: true, wizard: false, level:, casting_time: "", range: "", verbal: , somatic: , material: , components: "", duration: "", description: "You touch a living creature that has 0 hit points. The creature becomes stable. This spell has no effect on undead or constructs."},
  # {name: "", cleric: true, wizard: false, level:, casting_time: "", range: "", verbal: , somatic: , material: , components: "", duration: "", description: "You manifest a minor wonder, a sign of supernatural power, within range. This wonder can take the form of a supernaturally booming voice, flickering or altered flames, out-of-place or incongruent noises, harmless ground tremors, an unlocked door or window slamming shut or flying open, or an alteration in the appearance of the caster's eyes. If you cast this spell multiple times, you can have up to three of its 1-minute e ects active at a time, and you can dismiss such an e ect as an action."},
